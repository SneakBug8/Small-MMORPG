...
background = display.newImage ("assets/gui/background.png",  display.contentCenterX+16, display.contentCenterY+16)
...
closebutton = display.newImage ("assets/gui/close.png", inventory.x, inventory.y)
end
...
closebutton:addEventListener( "tap", closechat)
    local sceneGroup = self.view
